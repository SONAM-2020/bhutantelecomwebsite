...
<head>
  ...
  <title>Bhutan Telecom Ltd</title>
  <link rel="icon" href="<?php echo base_url();?>uploads/new.png" type="image/x-icon" />
  <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url();?>uploads/new.png" />
