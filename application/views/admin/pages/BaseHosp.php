<section class="content-header">
  <h1>
      Base Hospital Reporting Management
  </h1>
</section>
        ...
        <div class="box-body">
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td>
                <?php if($event['BHospital_Status']=="NotArrived"){ ?><span class="label label-danger"><?php echo $event['BHospital_Status'];?></span>
                      <?php } else{?>   
                          <span class="label label-success"><?php echo $event['BHospital_Status'];?></span>
                      <?php }?>
              </td>
              <td>
                <button type="button" class="btn btn-block btn-primary" onclick="editinfo('<?php echo $event['Id']?>','<?php echo $event['AmbulanceNumber']?>','<?php echo $event['Reason']?>','<?php echo $event['BaseHospital']?>','<?php echo $event['BaseDzongkhag']?>','<?php echo $event['DestinationHospital']?>','<?php echo $event['DestinationDzongkhag']?>','<?php echo $event['BHospital_Status']?>')"><i class="fa fa-edit"></i>Edit</button> 
              </td>
              </tr>
              <?php endforeach;?>
            </tbody>
   ...
   function editinfo(Editid,a,g,b,c,d,e,f){
    ...
    if(validateeditform()){
      $.blockUI
          ...
          var url='<?php echo base_url();?>index.php?adminController/EditAmbReporting';
