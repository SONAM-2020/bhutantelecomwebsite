        ...
        <div class="box-body">
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td>
                <?php if($event['Hotel_Status']=="NotArrived"){ ?><span class="label label-danger"><?php echo $event['Hotel_Status'];?></span>
                      <?php } else{?>   
                          <span class="label label-success"><?php echo $event['Hotel_Status'];?></span>
                      <?php }?>
              </td>
              <td>
                <button type="button" class="btn btn-block btn-primary" onclick="editinfo('<?php echo $event['Id']?>','<?php echo $event['AmbulanceNumber']?>','<?php echo $event['Reason']?>','<?php echo $event['BaseHospital']?>','<?php echo $event['BaseDzongkhag']?>','<?php echo $event['DestinationHospital']?>','<?php echo $event['DestinationDzongkhag']?>','<?php echo $event['Hotel_Status']?>')"><i class="fa fa-edit"></i>Edit</button> 
              </td>
              </tr>
              <?php endforeach;?>
            </tbody>
              ...
              <div class="row">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <input type="text" name="dtime" id="adtime" class="form-control" value="<?php echo date("Y-m-d H:i:s");?>">
                      </div>
                  </div>
                  <div class="form-group">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                      <label>Driver & Escort Room Type:</label>
                      <select id="room" onchange="showfield(this.value)" onclick="remove_err('room_err')" class="form-control" name="room">
                        <option value="">--Select--</option>
                        <option value="1">Same Room</option>
                        <option value="2">Different Room</option>
                      </select>
                      <span id="room_err" class="text-danger"></span>
                    </div>
                      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6"  style="display:none" id="samesection">
                        <label>Room No:</label>
                        <input type="text" name="sroom" id="sroom" class="form-control">
                      </div>
                      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6"  style="display:none" id="dsection">
                        <label>Driver Room No:</label>
                        <input type="text" name="droom" id="droom" class="form-control">
                      </div>
                      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6"  style="display:none" id="esection">
                        <label>Escort Room No:</label>
                        <input type="text" name="eroom" id="eroom" class="form-control">
                      </div>
                    </div>
                  <div class="form-group">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
   ...
   function editinfo(Editid,a,g,b,c,d,e,f){
    ...
    if(validateeditform()){
      $.blockUI
          ...
          var url='<?php echo base_url();?>index.php?adminController/EditAmbQuaraReporting';
