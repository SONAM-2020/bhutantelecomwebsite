        ...
        <div class="box-body">
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td><?php echo $event['RCDC_Location'];?></td>
              <td><?php echo $event['StartTime'];?></td>
              <td><?php echo $event['Reason'];?></td>
              <td>
                <?php if($event['RCDC_Status']=="NotArrived"){ ?><span class="label label-danger"><?php echo $event['RCDC_Status'];?></span>
                      <?php } else{?>   
                          <span class="label label-success"><?php echo $event['RCDC_Status'];?></span>
                      <?php }?>
              </td>
              <td>
                <button type="button" class="btn btn-block btn-primary" onclick="editinfo('<?php echo $event['Id']?>','<?php echo $event['AmbulanceNumber']?>','<?php echo $event['Reason']?>','<?php echo $event['BaseHospital']?>','<?php echo $event['BaseDzongkhag']?>','<?php echo $event['RCDC_Location']?>','<?php echo $event['StartTime']?>','<?php echo $event['RCDC_Status']?>')"><i class="fa fa-edit"></i>Edit</button> 
              </td>
              </tr>
              <?php endforeach;?>
            </tbody>
