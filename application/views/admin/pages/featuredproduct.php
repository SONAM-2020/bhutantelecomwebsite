  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Create New Featured Product</h3>
              ...
              <div class="row">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          <label>Description:<span class="text-danger">*</span></label>
                            <input type="text" id="Description" onclick="remove_err('Description_err')" name="Description" class="form-control">
                    ...
                    <div class="form-group">
                       <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                          <label>Images</label>
                             <label>Upload Slider Images:<span class="text-danger">*</span></label><span style="color: red;"><i>(Image Size:370*230)</i></span>
                    ...
                    <div class="form-group">
                       <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                          ...
                          <select id="type" onclick="remove_err('type_err')" class="form-control" name="type">
                            <option value="">-----</option>
...
<script type="text/javascript">
 ...
 function addinfo(){
    $('#actiontype').val('add');
    $('#medelheaderspan').html('Add Featured Product');
    $('#btnspan').html('<i class="fa fa-save"></i> Add Featured Product');
...
function addproductinfo(){
  ...
  $.blockUI
      ...
      var url='<?php echo base_url();?>index.php?adminController/Addfeatureproduct';
  ...
  function validateaddform(){
    ...
    if($('#price').val()==""){
      $('#price_err').html('Please Enter Product price.');
      retrtype=false;
    }
    return retrtype;
  }
