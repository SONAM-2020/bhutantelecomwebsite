        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td><?php echo $event['Desicription'];?></td>
                    ...
                    <div class="form-group">
                       <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                           <label>Page URL:<span class="text-danger">*</span></label>
                            <input type="text" id="pageurl" onclick="remove_err('pageurl_err')" name="pageurl" class="form-control">
                            <span id="pageurl_err" class="text-danger"></span>
                        </div>
                    </div>
                  </div>
              </div>
...
function addsliderinfo(){
  ...
  function validateaddform(){
    ...
    if($('#pageurl').val()==""){
      $('#pageurl_err').html('Please Enter Page URL.');
      retrtype=false;
    }
    return retrtype;
  }
